# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2018-12-13 20:12
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('inventory_management_app', '0014_auto_20181213_1455'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='inventory_management_app.Employee'),
        ),
        migrations.AlterField(
            model_name='project',
            name='project_manager',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventory_management_app.Employee'),
        ),
    ]
